            ...
            <Message {...post} key={post.id}>
              <div className="flex gap-4">
                <button
                  ...
                  className="text-pink-600 flex items-center justify-center gap-2 py-s text-sm"
                >
                  {" "}
                  <BsTrash2Fill />
                  Delete
                ...
                <Link href={{pathname: "/post", query: post}}> 
                  <button className="text-teal-600 text 2-xl flex items-center justify-center gap-2 py-s ">
                    {" "}
                    <AiFillEdit />
                    Edit
                  </button>
